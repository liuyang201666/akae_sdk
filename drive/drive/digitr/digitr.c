...
//#define CPLD_SEG7 *((volatile unsigned int *)0x20800080)
#define CPLD_SEG7 0x20800080
#define VM_SEG7 0x20800080
#define BEEP	GPB0
#define NOKEY '0'
...
#if 0
static ssize_t keyirq_write(struct file *filp, char __user *buf, size_t count, loff_t *f_ops)
{

	VM_SEG7 = ioremap(CPLD_SEG7, 4);
	writel(0x79, VM_SEG7);
...
int __init keyirq_init(void)
{
	...
	writel((S3C2410_GPB0_OUTP), S3C2410_GPBCON);
	writel((~(1 << 0)) & readl(S3C2410_GPBDAT), S3C2410_GPBDAT);
