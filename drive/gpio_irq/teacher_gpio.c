...
int __init keyirq_init(void)
{
	...
	printk("S3C2410_GPFCON = %d\n", (int)S3C2410_GPFCON);
	printk("S3C2410_GPBDAT = %d\n", (int)S3C2410_GPBDAT);
	printk(" S3C2410_GPF0_EINT0= %d, S3C2410_GPF2_EINT2 = %d\n",
			S3C2410_GPF0_EINT0,S3C2410_GPF2_EINT2 );
	printk("S3C2410_GPB9_OUTP = %d, S3C2410_GPB9_OUTP = %d\n",
			S3C2410_GPB8_OUTP, S3C2410_GPB9_OUTP );
	//设置GPF0与GPF2为中断模式
	writel((S3C2410_GPF0_EINT0 | S3C2410_GPF2_EINT2), S3C2410_GPFCON);
	//设置GPF管脚取消内部上拉电平
